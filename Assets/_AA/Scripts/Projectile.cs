...
public class Projectile : MonoBehaviour
{
    ...
    private void FixedUpdate()
    {
        ...
        if (_container.IsHoming && _elapsedTime >= _hoomingDelay && _container.SplitCount == 0)
        {
            ...
            _elapsedTime = 0; // Homing g�ncelleme s�resini s�f�rla
        }
    ...
    private void SplitProjectile()
    {
        ...
        // E�er velocity �ok k���kse fallback olarak transform.right kullan
        if (baseDirection.sqrMagnitude < 0.0001f)
            baseDirection = transform.right;

        float totalSpread = _container.SplitSpreadAngle; // �rn 50f
    ...
    private void ApplyHoming()
    {
        ...
        // Normalized Lerp yerine direkt velocity �zerinde MoveTowards
