...
[CreateAssetMenu(menuName = "BossActions/WhirlingStellBloom")]
public class WhirlingStellBloomAction : BossActionBase
{
    ...
    public override void Execute(GameObject weapon, Transform center, System.Action onComplete)
    {
        ...
        foreach (var clone in clones)
        {
            ...
            clone.transform.DORotate(new Vector3(0, 0, 360f * 2), 1f, RotateMode.FastBeyond360).SetRelative().SetEase(Ease.Linear);
        }
